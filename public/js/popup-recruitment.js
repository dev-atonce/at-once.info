...
$('input[name="position"]').on('change',function(){if($(this).is(':checked')){$(this).parent().addClass(color)}else{$(this).parent().removeClass(color)}});
$('input[name="nationality"]').on('change',function(){if($(this).is(':checked')){$(this).parent().addClass(color)}else{$(this).parent().removeClass(color)}});
$('input[name="employment"]').on('change',function(){if($(this).is(':checked')){$(this).parent().addClass(color)}else{$(this).parent().removeClass(color)}});
$('input[name="location"]').on('change',function(){if($(this).is(':checked')){$(this).parent().addClass(color)}else{$(this).parent().removeClass(color)}});
$('#position').hunterPopup({
    width: popUp.position.width,
    title: $('#position').attr('title'),
    content: $('#tableFirst'),
    placement: popUp.position.placement,
    ...
    event:function(){
        ...
        $('.list-toggle').click(function(){
            if($(this).next().hasClass('sub-position')){
                $(this).next().slideDown();
            }
        });
    }
...
$('#nationality').hunterPopup({
    width: popUp.nationality.width,
    title: $('#nationality').attr('title'),
    content: $('#tableSecond'),
    placement: popUp.nationality.placement,
    resetBtn: '.reset-all-filters',
    event:function(){
        box = $('#nationality');
        var second = {id:[],text:[]};
...
$('#employment').hunterPopup({
    width: popUp.employment.width,
    title: $('#employment').attr('title'),
    content: $('#tableThird'),
    placement: popUp.employment.placement,
    resetBtn: '.reset-all-filters',
    event:function(){
        box = $('#employment');
        var third = {id:[],text:[]};
...
{
    /*===================================*/
    box = {first:$('#position'),second:$('#nationality'),third:$('#employment'),fourth:$('#location'),fifth:$('#fifth'),sixth:$('#sixth')}
