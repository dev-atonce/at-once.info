(function($) {
    $.skEditor = function(box, options) {
        ...
        var group3 = '<div class="sk-btn-group">\
                <div class="sk-btn"><button type="button" class="sk paragraph"><i class="fas fa-paragraph fs-17"></i></button></div>\
        ...
        var group5 = '<div class="sk-btn-group">\
                <div class="sk-btn dropdown">\
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuBullet'+id+'">\
                        <a class="dropdown-item bullet" bullet="disc" href="javascript:" cmd="insertOrderedList">Default</a>\
                        <a class="dropdown-item bullet" bullet="circle" href="javascript:">Circle</a>\
                        <a class="dropdown-item bullet" bullet="square" href="javascript:">Square</a>\
                    </div>\
                </div>\
        ...
        var group7 = '<div class="sk-btn-group">\
                ...
                <div class="sk-btn"><button type="button" class="sk code" title="Source Code"><i class="fas fa-code fs-17"></i></button></div>\
            </div>';
                ...
                <div class="modal-content">\
                    <div class="modal-body">\
                        ...
                        <div class="row im-s">\
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 d-none"><div class="form-group"><label>alt=""</label><input type="text" class="form-control" name="im_alt" readonly=""></div></div>\
                            <div class="col-lg-6 col-md-6 col-xs-12 d-none"><div class="form-group"><label>class=""</label><input type="text" class="form-control" name="im_class" readonly=""></div></div>\
                            ...
                            <div class="col-lg-12 mt-2 mb-2 d-none">\
                                <div class="form-group">\
                                    ...
                                    <div class="input-group">\
                                        ...
                                        <input type="text" class="form-control" name="im_width" placeholder="Width" readonly="">\
                                        <input type="text" class="form-control" name="im_height" placeholder="Height" readonly="">\
                                    </div>\
                                </div>\
                            </div>\
                        ...
                        <div class="row im-f" style="display: none;">\
                            <div class="col-lg-12 im-tools">\
                                <button class="btn btn-outline-primary btn-sm im-upload" title="New upload"><i class="fas fa-upload fa-fw"></i>&nbsp;Upload</button>\
                                <button class="btn btn-outline-dark btn-sm im-refresh" title="Refresh"><i class="fas fa-sync fa-fw fa-xs"></i>&nbsp;Refresh</button>\
                                <button class="btn btn-outline-danger btn-sm im-delete" title="Delete"><i class="fas fa-trash fa-fw fa-xs"></i>&nbsp;Delete</button>\
                                <div class="float-right">\
                        ...
                        <div class="row im-u" style="display: none;">\
                            ...
                            <div class="col-lg-12 float-right"><button class="btn btn-secondary my-3 btn-sm im-btn-choose">Add files <input type="file" name="im_upload" multiple style="display: none"></button><span class="text-danger ml-1" style="font-size:14px;">*ขนาดไฟล์ไม่เกิน 2MB</span></div>\
                            <div class="col-lg-12 im-footer">\
                                <div class="float-right">\
        ...
        var templateModal = $('<div class="modal fade" id="sk-template-'+id+'" tabindex="-1" role="dialog" aria-labelledby="templateTitle" aria-hidden="true">\
            ...
            <div class="modal-content">\
                ...
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-4 img" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    <div class="col-lg-8 txt bl-1" data-text="Text" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-6 img" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    <div class="col-lg-6 txt bl-1" data-text="Text"  style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-8 img" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    <div class="col-lg-4 txt bl-1" data-text="Text" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-12 txt bl-1" data-text="Text" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-4 txt" data-text="Text" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    <div class="col-lg-8 img bl-1" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-6 txt" data-text="Text" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    <div class="col-lg-6 img bl-1" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-8 txt" data-text="Text" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    <div class="col-lg-4 img bl-1" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-3 img" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    <div class="col-lg-3 img bl-1" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    <div class="col-lg-3 img bl-1" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    <div class="col-lg-3 img bl-1" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    </div>\
                </div>\
                ...
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-12 img" data-text="Image" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Image</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
                    <div class="col-lg-6 txt" data-text="Text" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    <div class="col-lg-6 txt bl-1" style="min-height:20px;"><div style="display:grid; padding: 10px 0 10px 0;"><h5 style="margin:auto;">Text</h5></div></div>\
                    </div>\
                </div>\
                <div class="template-item card my-2">\
                    <div class="row">\
        ...
        var imageArea = '<div class="sk-img" class=" style="display:grid;" ><h5 style="margin:auto;">IMAGE</h5></div>';
        var removeButton = '\
        ...
        area.find('.row').each(function(i,item){
            ...
            // $(item).find('.col-txt').html()
            $.each($(item).find('.col-img'),function(k,col){
                $(col).children().not('.img-caption').addClass('sk-img');
                $(col).attr('data-text','Image');
                if($(this).find('img').length==0 && $(this).find('.sk-img').length==0)$(col).append(imageArea);
        ...
        //================= Command in editor =================//
        area.find('.sk.undo').click(function(){document.getSelection();document.execCommand("undo",false,null)});
        area.find('.sk.redo').click(function(){document.getSelection();document.execCommand("redo",false,null)});
        const Heading = (e) =>{
        ...
        area.find('.sk.heading').click(function(){ Heading(this) });
        area.find('.sk.text-indent').click(function(){ TextIndent() });
        area.find('.sk.paragraph').click(function(){document.getSelection();document.execCommand('formatblock', false, 'p') });
        area.find('.font-size').click(function(){document.getSelection();document.execCommand('fontSize',false,parseFloat($(this).attr('size'))) });
        area.find('.sk.bold').click(function(){document.getSelection();document.execCommand("bold",false,null)});
        area.find('.sk.underline').click(function(){document.getSelection();document.execCommand("underline",false,null)});
        area.find('.sk.italic').click(function(){document.getSelection();document.execCommand("italic",false,null)});
        area.find('.sk.color').click(function(){color=$(this).find('.sk-preview');color=color.attr('style');if(color!=undefined)color=color.split(':');color=color[1].replace(';','');document.getSelection();document.execCommand('foreColor',false,color)})
        //------- SOURCE CODE -------/
        area.on('click','.source-code',function(){
            const current = $(this);
            const row = current.closest('.row');
            const html = row.clone();
        ...
        codeModal.find('.sk-ok').click(function(){const code=$(this).closest('.modal-content').find('textarea').val();area.find('.sk-tools').next().html(code);codeModal.modal('hide')});
        codeModal.find('.sk-dismiss').click(function(){codeModal.modal('hide')});
        area.find('.sk.left').click(function(){document.getSelection();document.execCommand('justifyLeft',false,null)});
        area.find('.sk.center').click(function(){document.getSelection();document.execCommand('justifyCenter',false,null)});
        area.find('.sk.right').click(function(){document.getSelection();document.execCommand('justifyRight',false,null)});
        area.find('.sk.justify').click(function(){document.getSelection();document.execCommand('justifyFull',false,null)});
        area.find('.dropdown-item.bullet').click(function(){
        ...
        area.find('.sk.list-number').click(function(){document.getSelection();document.execCommand($(this).attr('cmd'),false,null)});
        area.find('.sk.indent').click(function(){document.getSelection();document.execCommand('indent',false,null)});
        area.find('.sk.outdent').click(function(){document.getSelection();document.execCommand('outdent',false,null)});
        area.find('.sk.hr').click(function(){document.getSelection();document.execCommand('insertHorizontalRule',false,null)});
        const currentSelect = () => {
            ...
            if(sText.baseNode.nodeName=='#text' && sText!=''){
                // console.log($(sText.anchorNode?.parentNode))
                document.execCommand('insertHTML', false, '<a href="https://www.example.com" target="_self" title="">' + sText + '</a>')
            }
            var current = $(sText.anchorNode?.parentNode);
                // $(sText.anchorNode?.parentNode)
            ...
            LinkModal.find('select[name="link-target"]').map(function(){
                if($(this).val() == $(sText.anchorNode?.parentNode).attr('title')){
                    $(this).attr('selected');
                }
            })            
        ...
        area.find('.sk.link').click(function(){ currentSelect() })
        ...
        templateModal.find('.select-template').click(function(){
            ...
            template.find('.img').removeClass('img').addClass('col-img').children().addClass('sk-img').find('h5').remove();
            ...
            template.find('.bl-1').removeClass('bl-1');
        ...
        //================= Remove Row =================//
        $(document).on('click','.sk.remove-content',function(){$(this).closest('.row').remove()});
        //================= Image Manager =================//
        var im = ImageModal;
        var ts = im.find('.im-s');
        var tf = im.find('.im-f');
        ...
        $(document).on('click','.sk-remove',function(){$(this).closest('.sk-row').remove();});       
        area.on('click','.sk-img',function(){
            ...
            if($(this).find('img').length>0){
                ...
                if(image.parent().next().hasClass('img-caption')){ 
                    ImageModal.find('input[name="im_caption"]').prop('checked',true); 
                }
            }else{
        ...
        ImageModal.on('click','.im-select',function(){
            ...
            let required = ImageModal.find('input[required^=""]');
            let error = [];
            required.map(function(v, k){ 
                if(v.val() == ''){ v.addClass('error'); error.push(v.attr('name')) }
                else{ v.removeClass('error'); error[v.attr('name')]; }
            })
            console.log(error)
            ...
            if($(this).closest('.row').hasClass('im-s')) {
                ...
                if(im_caption.is(':checked')) 
                    if(newImg.parent().parent().find('.img-caption').length==1) $('.img-caption'); else $('<div class="img-caption" contenteditable="true">Caption</div>').insertAfter(newImg.parent());
                else 
        ...
        ImageModal.on('click','.im-delete',function(){
            if ($('.im-checked').length>0) {
                if(confirm('ลบรูปนี้ใช่หรือไม่!')){
                    $.ajax({method:'get',url: prefix+'/'+imModule+'/delete/profile-image',data:{u:$('.im-checked').find('img').attr('src')},dataType:'JSON',success:function(data){if(data===true)$('.im-checked').remove()}});
                }
            }
        })
