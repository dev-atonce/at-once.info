...
$('#seat').hunterPopup({
    width: popUp.seat.width,
    title: $('#seat').attr('title'),
    content: $('#tableFourth'),
    placement: popUp.seat.placement,
    resetBtn: '.reset-all-filters',
    event:function(){
        box = $('#seat');
        var fourth = {id:[],text:[]};
...
{
    /*===================================*/
    box = {first:$('#location'),second:$('#type'),third:$('#service'),fourth:$('#seat'),fifth:$('#fifth'),sixth:$('#sixth')}
