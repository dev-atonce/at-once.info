...
$('#rental').hunterPopup({
    width: popUp.rental.width,
    title: $('#rental').attr('title'),
    content: $('#tableFourth'),
    placement: popUp.rental.placement,
    resetBtn: '.reset-all-filters',
    event:function(){
        box = $('#rental');
        var fourth = {id:[],text:[]};
...
{
    /*===================================*/
    box = {first:$('#location'),second:$('#type'),third:$('#service'),fourth:$('#rental'),fifth:$('#fifth'),sixth:$('#sixth')}
