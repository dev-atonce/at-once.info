...
$('#consulting').hunterPopup({
    width: popUp.consulting.width,
    title: $('#consulting').attr('title'),
    content: $('#tableSecond'),
    placement: popUp.consulting.placement,
    resetBtn: '.reset-all-filters',
    event:function(){
        box = $('#consulting');
        var second = {id:[],text:[]};
...
{
    /*===================================*/
    box = {first:$('#location'),second:$('#consulting'),third:$('#service'),fourth:$('#fourth'),fifth:$('#fifth'),sixth:$('#sixth')}
