(function( $ ){
    ...
    function _init() {
        ...
        me.on('change', 'input.tree', __changeHandler);
        ...
        if (settings.autoExpand) {
            me.find('ul.collapse').addClass('show').removeClass('hide');
        }
        ...
        me.find('li').each(function( index, element ) {
            ...
            var chk = $('<input/>').prop('type', 'checkbox')
                                   .prop('class', 'tree ')
                                   .prop('name','_id')
                                   .attr('value', elmt.attr('data-value'))
                                   .attr('data-position',elmt.attr('data-position'))
                                   .attr('data-id',elmt.attr('data-value'));

            // var hid = $('<input/>').prop('type', 'hidden')
            //                        .prop('name', 'position')
            //                        .prop('value', elmt.attr('data-position'));
