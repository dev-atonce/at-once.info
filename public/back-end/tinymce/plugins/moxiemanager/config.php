...
// $moxieManagerConfig['filesystem.rootpath'] = "Files=".$_SERVER["DOCUMENT_ROOT"]."/upload;Upload=ftp://Files";
$moxieManagerConfig['filesystem.rootpath'] = "Files=ftp://Files";  ///webroot/uploads';
