...
class ItCtrl extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $counts = count($service) + count($software) + count($hardware) + count($solution) + count($location);

            $swLength = count($software);
            ...
            ->where(['company.public'=>1,'company.industry' => $this->industryId()])
            ->select([
                'company.id',
    ...
    public function filtersHtml($cid)
    {
        ...
        if ($filters['software']->count()>0) {
            $html.='<div class="row"><div class="col-lg-2"><h5 class="title bold"><i class="icofont-verification-check text-success"></i>'.__("phrase.$this->industry.filter.software").'</h5></div><div class="col-lg-10"><ul class="ey7ls2-0"><li class="fa-Dycg"><div class="bDELcg">';
        ...
        if ($filters['hardware']->count()>0) {
            $html.='<div class="row"><div class="col-lg-2"><h5 class="title bold"><i class="icofont-verification-check text-success"></i>'.__("phrase.$this->industry.filter.hardware").'</h5></div><div class="col-lg-10"><ul class="ey7ls2-0"><li class="fa-Dycg"><div class="bDELcg">';
        ...
        if ($filters['solution']->count()>0) {
            $html.='<div class="row"><div class="col-lg-2"><h5 class="title bold"><i class="icofont-verification-check text-success"></i>'.__("phrase.$this->industry.filter.solution").'</h5></div><div class="col-lg-10"><ul class="ey7ls2-0"><li class="fa-Dycg"><div class="bDELcg">';
