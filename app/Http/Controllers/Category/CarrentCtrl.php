...
class CarrentCtrl extends Controller
{
    ...
    public function thisQuery()
    {
        ...
        ->where(['company.category'=>$this->categoryId(),'company.public'=>true]);
        return $query;
    }
    ...
    public function store(Request $request)
    {
        ...
        switch ($request->step) {
            ...
            case 2:
                ...
                $CpCarTypeMd = \App\Models\Filter\CpCarTypeMd::class;
                ...
                $CpPeriodMd = \App\Models\Filter\CpPeriodMd::class;
    ...
    public function cp($id=null)
    {
        ...
        $carType = \App\Models\Filter\CpCarTypeMd::select("ch.name_$lang as name")->leftJoin('choice as ch','cp_cartype.type','=','ch.key')->where(['cp_cartype._id'=>@$cp->id,'ch.type'=>'car']);
        ...
        $period = \App\Models\Filter\CpPeriodMd::select("ch.name_$lang as name")->leftJoin('choice as ch','cp_period.type','=','ch.key')->where(['cp_period._id'=>@$cp->id,'ch.type'=>'contract-period']);
        $condition = \App\Models\Filter\CpConditionMd::select(["ch.name_$lang as name"])->leftJoin('choice as ch','cp_condition.condition','=','ch.key')->where(['cp_condition._id'=>@$cp->id,'ch.type'=>'other-conditions']);
