...
class ConstructionMaterialsCtrl extends Controller
{
    public static function index($request)
    {
        try
        {
            ...
            $materials = array_filter(explode(',',$request->get('construction-materials')));
            $sport = array_filter(explode(',',$request->sport));
            $location = array_filter(explode(',',$request->location));
            $keywords = $request->keywords;

            $count = count($materials) + count($sport) + count($location);
