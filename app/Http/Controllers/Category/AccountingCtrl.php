...
class AccountingCtrl extends Controller
{
    ...
    public static function index($request)
    {
        ...
        $count = count($location)+count($other)+count($service)+count($nationality);
    ...
    public function filtersHtml($cid)
    {
        ...
        if ($filters['other']->count()>0) {
            $html.='<div class="row mb-2">';
            $html.='<div class="col-lg-2"><h5 class="title bold"><i class="icofont-verification-check text-success"></i> '.__("phrase.$this->category.filter.other").'</h5></div>';
            $html.='<div class="col-lg-10"><ul class="ey7ls2-0"><li class="fa-Dycg"><div class="bDELcg">';     
        ...
        if ($filters['nationality']->count()>0) {
            $html.='<div class="row mb-2">';
            $html.='<div class="col-lg-2"><h5 class="title bold"><i class="icofont-verification-check text-success"></i> '.__("phrase.$this->category.filter.nationality").'</h5></div>';
            $html.='<div class="col-lg-10"><ul class="ey7ls2-0"><li class="fa-Dycg"><div class="bDELcg">';     
