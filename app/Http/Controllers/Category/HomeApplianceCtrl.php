...
class HomeApplianceCtrl extends Controller
{
    ...
    public static function index($request)
    {
        ...
        $count = count($product) + count($location);
        ...
        ->when($request->product,function($query) use($product){
            ...
            return $query->join('cp_product as cpp','company.id','=','cpp._id')
                ->whereIn('cpp.type',$product)
