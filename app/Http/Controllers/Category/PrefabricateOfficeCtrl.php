...
class PrefabricateOfficeCtrl extends Controller
{
    ...
    public function testQuery(Request $request)
    {
        ...
        $newQuery = \App\Models\CompanyMd::where([
            'company.type' => 'full',
            'company.public' => 1,
            'company.category' => $this->categoryId()
        ])        
        ...
        return view("$this->prefix.$this->category.index-test",[
            'prefix' => $this->prefix,
            ...
            'blogs' => \App\Http\Controllers\BlogCtrl::inMainpage($type=$this->categoryId(),$limit=36),
