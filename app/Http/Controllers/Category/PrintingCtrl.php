...
class PrintingCtrl extends Controller
{
    ...
    public static function index(Request $request)
    {
        ...
        try {
            ...
            $count = count($type)+count($minimum)+count($other)+count($location);
    ...
    public function filtersHtml($cid)
    {
        ...
        if ($filters['minimum']->count()>0) {
            $html.='<div class="row"><div class="col-lg-2"><h5 class="title bold"><i class="icofont-verification-check text-success"></i>'.__("phrase.$this->category.filter.minimum").'</h5></div><div class="col-lg-10"><ul class="ey7ls2-0"><li class="fa-Dycg"><div class="bDELcg">';
        ...
        if ($filters['other']->count()>0) {
            $html.='<div class="row"><div class="col-lg-2"><h5 class="title bold"><i class="icofont-verification-check text-success"></i>'.__("phrase.$this->category.filter.other-service").'</h5></div><div class="col-lg-10"><ul class="ey7ls2-0"><li class="fa-Dycg"><div class="bDELcg">';
