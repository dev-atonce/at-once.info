...
class LogisticsCtrl extends Controller
{
    ...
    public static function index($request)
    {
        ...
        $count = count($international)+ count($methods)+ count($warehouse)+ count($services)+count($item);
        ...
        ->when($request->warehouse,function($query)use($warehouse){
            ...
            return $query
                ->whereHas('warehouse',function($sub)use($warehouse,$length){
                    $sub->where('type','location-warehouse')
                        ->whereIn('warehouse',$warehouse)
