...
class CoWorkingCtrl extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $counts = count($location)+count($type)+count($service)+count($seat);
    ...
    public function confirmation(Request $reqiest)
    {
    ...
    public function filtersHtml($cid)
    {
        ...
        if(@$filters['seat']->count()>0){
            $html.='<div class="row"><div class="col-lg-2"><h5 class="title bold"><i class="icofont-verification-check text-success"></i>'.__("phrase.$this->industry.filter.seat").'</h5></div><div class="col-lg-10">';
            $html.='<ul class="ey7ls2-0"><li class="fa-Dycg"><div class="bDELcg">';
