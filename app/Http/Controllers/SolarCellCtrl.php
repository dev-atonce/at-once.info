...
class SolarCellCtrl extends Controller
{
    ...
    public function filters($cid)
    {
        ...
        return [
            ...
            'condition' => \App\Models\CpConditionMd::select(["ch.name_$lang as name"])->leftJoin('choice as ch','cp_condition.condition','=','ch.key')->where(['cp_condition._id'=>@$cid,'ch.type'=>'solar-cell-condition'])
        ];
    }
    ...
    public function cp($id=null)
    {
        ...
        $condition = \App\Models\CpConditionMd::select(["ch.name_$lang as name"])->leftJoin('choice as ch','cp_condition.condition','=','ch.key')->where(['_id'=>@$cp->id,'ch.type'=>'solar-cell-condition']);
