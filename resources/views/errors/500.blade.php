...
<section class="sec-404">
    <div class="">
        ...
        <div class="error404">
          ...
          <div class="error__description">บางอย่างผิด</div>
          <button class="error__button error__button--active">กลับหน้าแรก</button>
          <button class="error__button error__button--active02">ติดต่อ At Once</button>
      </div>
  </section>
  <div class="02">
      <div class="astronaut">
