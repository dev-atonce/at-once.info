...
<body>
  ...
  .sec-404{
    ...
    margin: 0px;
    overflow: hidden;
    background: linear-gradient( 91deg , #1A315F 0%, #0E2439 90%);
  }
...
.error__button--active:hover , .error__button--active02:hover {
...
<section class="sec-404">
  <div class="container-fluid">
    ...
    <div class="error404">
      {{-- <div class="error__title">ไม่พบหน้าเว็บไซต์ที่คุณต้องการ</div> --}}
      {{-- <div class="error__description">ขออภัย ไม่พบหน้าเว็บไซต์ที่คุณต้องการ</div> --}}
      <div class="error__description mb-3">ขออภัย ไม่พบหน้าเว็บไซต์ที่คุณต้องการ <br> This page could not be found.</div>
      <div class="error__description02 mb-3">เรากำลังพาคุณไปหน้าแรก เพื่อใช้งานเว็บไซต์ต่อ..</div>
      <br>
      <div>
    <!--   <a href="{{url('/')}}/{{Session('lang')}}" class="error__button error__button--active">กลับหน้าแรก</a>
      <a href="{{url('/')}}/{{Session('lang')}}/contact" class="error__button error__button--active02">ติดต่อ At Once</a> -->
    </div>
  </div>
</div>
<div class="02">
...
<script>
  ...
  $('.content').css({
    'height': 'calc(100vh - '+(headerHeight+footerHeight+49)+'px)'
  })
