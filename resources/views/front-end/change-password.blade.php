...
<script>
    ...
    $('#change-password').validate({
        ...
        rules : {
            ...
            confirm : { required : true, minlength:8,equalTo:'#password'},
        },
        messages : {
            password : {required:errMessage.password_require[hl],minlength:errMessage.minlength[hl]+' {0} '+errMessage.characters[hl]},
            confirm : {required:errMessage.new_password[hl],minlength:errMessage.minlength[hl]+' {0} '+errMessage.characters[hl],equalTo:errMessage.equalTo[hl]}
        },
