...
<head>
    ...
    <link href="css/panel-box.css?v=0003" rel="stylesheet">
                            ...
                            <div class="row service-check">
                                <div class="col-lg-12 d-flex mb-2">
                                    ...
                                    <div class="bDELcg">
                                        ...
                                        @foreach ($items as $i)
                                        <div class="pix1uw-0">
                                            {{ $i->name ?? $i->name_th ?? $i->name_en ?? $i->name_zh ?? $i->name_jp ?? '' }}
                                        </div>
                                        @endforeach
                                    </div>
                                    @endif
                                                ...
                                                <div class="vertical-table none-absolute">
                                                    <div class="vertical-align-middle">
                                                        <div class="social-box">
                                                            ...
                                                            @endphp
                                                            @foreach ($snsLinks as $snsKey => $sns)
                                                            @php
                                                            $snsUrl = trim((string) @$row->$snsKey);
                                                            if ($snsUrl != '' && !preg_match('#^https?://#i', $snsUrl)) $snsUrl = 'https://' . $snsUrl;
                                                            @endphp
                                                            <a class="black-text-contact" target="_blank"
                                                                data-toggle="tooltip" data-placement="top"
                                                                title="{{ $sns['title'] }}"
                                                                @if ($snsUrl != '') href="{{ $snsUrl }}" rel="noopener" @else href="javascript:" @endif>
                                                                <div
                                                                    class="detail-contact-02 @if ($snsUrl == '') none-info @endif {{ $snsKey }}-contact">
                                                                    <svg viewBox="0 0 24 24" aria-hidden="true"><path d="{{ $sns['path'] }}"/></svg>
                                                                </div>
                                                            </a>
                                                            @endforeach
