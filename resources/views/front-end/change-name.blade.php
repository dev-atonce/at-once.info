            ...
            <form id="change-name" action="" method="post">
              ...
              <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-group">                      
                        <input type="text" name="name_ch" id="name_ch" class="form-control" value="{{$row->name_ch}}">
          ...
          rules : {
              ...
              name_ch : { 
                ...
                remote: { 
                  depends: function(){ return $('#changeName').is(':checked') },
                  param: {
                    url: 'check/name?hl=ch', type: 'get', data : { name: function(){return $('#name_ch').val() } } } 
                  }
              },
          },
          messages : {
              ...
              name_ch : {required: errMessage.th_require[hl], remote: errMessage.remote[hl]}
          },
