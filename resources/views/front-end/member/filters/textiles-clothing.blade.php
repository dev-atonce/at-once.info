@php
    $lang = Session('lang');
    $get['service'] = \App\Models\ChoiceMd::select('key',"name_$lang as name")->where('type','textiles-garments')->get();
...
<div class="form-group">
    <h6 class="bold text-secondary">@lang('phrase.textiles-clothing.filter.service')</h6>
