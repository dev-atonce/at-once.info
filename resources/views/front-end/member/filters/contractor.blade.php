@php
    ...
    $get['service'] = \App\Models\ChoiceMd::select('key',"name_$lang as name")->where('type','contractors-service')->get();
    $get['other'] = \App\Models\ChoiceMd::select('key',"name_$lang as name")->where('type','contractors-detail')->get();
...
<div class="form-group">
    <h6 class="bold text-secondary">@lang('phrase.contractor.filter.service')</h6>
...
<div class="form-group">
    <h6 class="bold text-secondary">@lang('phrase.contractor.filter.other')</h6>
...
<div class="form-group">
    <h6 class="bold text-secondary location-label" data-val="{{json_encode(@$location)}}">
        @lang('phrase.contractor.filter.location')
    </h6>
