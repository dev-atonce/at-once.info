@php
    ...
    $get['service'] = \App\Models\ChoiceMd::select('key',"name_$lang as name")->where('type','package-service')->get();
    $get['other'] = \App\Models\ChoiceMd::select('key',"name_$lang as name")->where('type','package-other')->get();
...
<div class="form-group">
    <h6 class="bold text-secondary">@lang('phrase.package.filter.service')</h6>
...
<div class="form-group">
    <h6 class="bold text-secondary">@lang('phrase.package.filter.other')</h6>
...
<div class="form-group">
    <h6 class="bold text-secondary location-label" data-val="{{json_encode(@$location)}}">
        @lang('phrase.package.filter.location')
    </h6>
