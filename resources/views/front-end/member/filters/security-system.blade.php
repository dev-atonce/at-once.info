@php
    ...
    $get['service'] = \App\Models\ChoiceMd::select('key',"name_$lang as name")->where('type','security-system-service')->get();
...
<div class="form-group">
    <h6 class="bold text-secondary">@lang('phrase.security-system.filter.service')</h6>
...
<div class="form-group">
    <h6 class="bold text-secondary location-label" data-val="{{json_encode(@$location)}}">
        @lang('phrase.security-system.filter.location')
    </h6>
