...
<body>
                    ...
                    <div class="right">
                        <div class="group-box-right">
                            <div class="row my-cover">
                                <div class="col-lg-12">
                                    @php
                                        $check = Storage::disk(env('disk'))->exists("images/company/$row->cover");
                            ...
                            <form action="" method="post">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4">
                                            <ul class="nav nav-tabs info-member" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link" id="profile-tab" data-toggle="tab"
                                                        href="#des_zh" role="tab" aria-controls="profile"
                                                        aria-selected="false"><img class="mr-2" width="25"
                                                            src="images/flag_ch.jpg" alt="中国人"> 中文</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content  info-member" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade" id="des_zh" role="tabpanel"
                                                    aria-labelledby="profile-tab">
                                                    <textarea id="description_zh" name="description_zh" class="form-control" rows="4" cols="50"
                                                        placeholder="Eg.Our vision is to have constant growth with quality.">{!! $row->description_zh !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <center>
                                                    ...
                                                    <div class="col-10">
                                                        <div class="row">
                                                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-1">
                                                                <button type="button"
                                                                    class="btn btn-primary btn-translate-description-th w-100 h-100">
                                                                    <span>ไทย </span><i
                                                            ...
                                                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-1">
                                                                <button type="button"
                                                                    class="btn btn-primary btn-translate-description-en w-100 h-100">
                                                                    <span>English </span><i
                                                                        class="fas fa-long-arrow-alt-right"></i><span>
                                                                        Others</span>
                                                                </button>
                                                            ...
                                                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-1">
                                                                <button type="button"
                                                                    class="btn btn-primary btn-translate-description-jp w-100 h-100">
                                                                    <span>日本語 </span><i
                                                                        class="fas fa-long-arrow-alt-right"></i><span>
                                                                        他の言語</span>
                                                                </button>
                                                            ...
                                                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-1">
                                                                <button type="button"
                                                                    class="btn btn-primary btn-translate-description-cn w-100 h-100">
                                                                    <span>中文 </span><i
                                                                        class="fas fa-long-arrow-alt-right"></i><span>
                                                                        其他</span>
                                                                </button>
                                ...
                                <div class="mb-4">
                                    ...
                                    <ul class="nav nav-tabs info-member" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#det_zh"
                                                role="tab" aria-controls="profile" aria-selected="false"><img
                                    ...
                                    <div class="tab-content  info-member" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="det_zh" role="tabpanel"
                                            aria-labelledby="home-tab">
                                            <div class="row">
                                                <div class="col-12 col-lg-12">
                                                    <div class="sk-area" data-lang="ch">
                                                        <textarea name="more_zh" id="more_zh" class="sk-editor" hidden="">{{ $row->more_zh }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row justify-content-center align-items-center">
                                            <div class="col-10">
                                                <div class="row">
                                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-1">
                                                        <button type="button"
                                                            class="btn btn-primary btn-translate-details-th w-100 h-100">
                                                            <span>ไทย </span><i
                                                                class="fas fa-long-arrow-alt-right"></i><span>
                                                                อื่นๆ</span>
                                                        </button>
                                                    ...
                                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-1">
                                                        <button type="button"
                                                            class="btn btn-primary btn-translate-details-en w-100 h-100">
                                                            <span>English </span><i
                                                                class="fas fa-long-arrow-alt-right"></i><span>
                                                                Others</span>
                                                        </button>
                                                    ...
                                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-1">
                                                        <button type="button"
                                                            class="btn btn-primary btn-translate-details-jp w-100 h-100">
                                                            <span>日本語 </span><i
                                                                class="fas fa-long-arrow-alt-right"></i><span>
                                                                他の言語</span>
                                                        </button>
                                                    ...
                                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-1">
                                                        <button type="button"
                                                            class="btn btn-primary btn-translate-details-cn w-100 h-100">
                                                            <span>中文 </span><i
                                                                class="fas fa-long-arrow-alt-right"></i><span>
                                                                其他</span>
                                                        </button>
    ...
    <script src="js/build/media.image.js?v=b"></script>
    ...
    <script>
        ...
        async function Translate(data) {
            ...
            const request = await fetch("th/member/profile/translate/save", {
                method: "post",
                headers: {
        ...
        // Translate Button
        const translateDetailsBtnTh = document.querySelector(".btn-translate-details-th")
        const translateDetailsBtnEn = document.querySelector(".btn-translate-details-en")
        const translateDetailsBtnJp = document.querySelector(".btn-translate-details-jp")
        const translateDetailsBtnCn = document.querySelector(".btn-translate-details-cn")
        const translateDescriptionBtnTh = document.querySelector(".btn-translate-description-th")
        const translateDescriptionBtnEn = document.querySelector(".btn-translate-description-en")
        const translateDescriptionBtnJp = document.querySelector(".btn-translate-description-jp")
        const translateDescriptionBtnCn = document.querySelector(".btn-translate-description-cn")
        const saveBtn = document.querySelector("#save-btn")

        let monthlyDetailsUse = "{{ $monthly_details_use }}";
        let monthlyDescriptionUse = "{{ $monthly_description_use }}";

        if (monthlyDetailsUse >= 10) {
            translateDetailsBtnTh.classList.replace("btn-primary", "btn-secondary");
            translateDetailsBtnEn.classList.replace("btn-primary", "btn-secondary");
            translateDetailsBtnJp.classList.replace("btn-primary", "btn-secondary");
            translateDetailsBtnCn.classList.replace("btn-primary", "btn-secondary");
            translateDetailsBtnTh.setAttribute('disabled', '');
            translateDetailsBtnEn.setAttribute('disabled', '');
            translateDetailsBtnJp.setAttribute('disabled', '');
            translateDetailsBtnCn.setAttribute('disabled', '');
        }

        if (monthlyDescriptionUse >= 10) {
            translateDescriptionBtnTh.classList.replace("btn-primary", "btn-secondary");
            translateDescriptionBtnEn.classList.replace("btn-primary", "btn-secondary");
            translateDescriptionBtnJp.classList.replace("btn-primary", "btn-secondary");
            translateDescriptionBtnCn.classList.replace("btn-primary", "btn-secondary");
            translateDescriptionBtnTh.setAttribute('disabled', '');
            translateDescriptionBtnEn.setAttribute('disabled', '');
            translateDescriptionBtnJp.setAttribute('disabled', '');
            translateDescriptionBtnCn.setAttribute('disabled', '');
        }

        translateDetailsBtnTh.addEventListener('click', (e) => {
            e.preventDefault()
            Swal.fire({
                title: "Are you sure?",
                ...
                confirmButtonText: "Translate and Save!"
            }).then((result) => {
                if (result.isConfirmed) {
                    Translate({
                        id: document.querySelector("input[name='id']").value,
                        description_th: document.querySelector("textarea[name='description_th']")
                            .value,
                        more_th: document.querySelector("#det_th").querySelector(".sk-body")
                            .innerHTML,
                        content_type: "details",
                        source_lang: "th"
                    }).then((res) => {
                        // alert(res.message)
                        document.querySelector("#det_en").querySelector(".sk-body").innerHTML = res
                            .more_en
                        document.querySelector("#det_jp").querySelector(".sk-body").innerHTML = res
                            .more_jp
                        document.querySelector("#det_zh").querySelector(".sk-body").innerHTML = res
                            .more_zh
                        document.querySelector("#details_use").innerHTML = res
                            .monthly_det_use
        ...
        translateDetailsBtnEn.addEventListener('click', (e) => {
            e.preventDefault()
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this!",
                ...
                if (result.isConfirmed) {
                    Translate({
                        id: document.querySelector("input[name='id']").value,
                        description_en: document.querySelector("textarea[name='description_en']")
                            .value,
                        more_en: document.querySelector("#det_en").querySelector(".sk-body")
                            .innerHTML,
                        content_type: "details",
                        source_lang: "en"
                    }).then((res) => {
                        // alert(res.message)
                        document.querySelector("#det_th").querySelector(".sk-body").innerHTML = res
                            .more_th
                        document.querySelector("#det_jp").querySelector(".sk-body").innerHTML = res
                            .more_jp
                        document.querySelector("#det_zh").querySelector(".sk-body").innerHTML = res
        ...
        translateDetailsBtnJp.addEventListener('click', (e) => {
            e.preventDefault()
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this!",
                ...
                if (result.isConfirmed) {
                    Translate({
                        id: document.querySelector("input[name='id']").value,
                        description_jp: document.querySelector("textarea[name='description_jp']")
                            .value,
                        more_jp: document.querySelector("#det_jp").querySelector(".sk-body")
                            .innerHTML,
                        content_type: "details",
                        source_lang: "jp"
                    }).then((res) => {
        ...
        translateDetailsBtnCn.addEventListener('click', (e) => {
            e.preventDefault()
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this!",
                ...
                if (result.isConfirmed) {
                    Translate({
                        id: document.querySelector("input[name='id']").value,
                        description_zh: document.querySelector("textarea[name='description_zh']")
                            .value,
                        more_zh: document.querySelector("#det_zh").querySelector(".sk-body")
                            .innerHTML,
                        content_type: "details",
                        source_lang: "ch"
                    }).then((res) => {
        ...
        translateDescriptionBtnTh.addEventListener('click', (e) => {
            e.preventDefault()
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this!",
                ...
                if (result.isConfirmed) {
                    Translate({
                        ...
                        document.querySelector("textarea[name='description_en']").value = res
                            .description_en
                        document.querySelector("textarea[name='description_jp']").value = res
                            .description_jp
                        document.querySelector("textarea[name='description_zh']").value = res
                            .description_zh
                        document.querySelector("#description_use").innerHTML = res
                            .monthly_des_use
                        ...
                        if (res.monthly_des_use >= 10) {
                            translateDescriptionBtnTh.classList.replace("btn-primary",
                                "btn-secondary");
                            translateDescriptionBtnEn.classList.replace("btn-primary",
                                "btn-secondary");
                            translateDescriptionBtnJp.classList.replace("btn-primary",
                                "btn-secondary");
                            translateDescriptionBtnCn.classList.replace("btn-primary",
                                "btn-secondary");
                            translateDescriptionBtnTh.setAttribute('disabled', '');
                            translateDescriptionBtnEn.setAttribute('disabled', '');
                            translateDescriptionBtnJp.setAttribute('disabled', '');
        ...
        translateDescriptionBtnEn.addEventListener('click', (e) => {
            e.preventDefault()
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this!",
                ...
                if (result.isConfirmed) {
                    Translate({
                        ...
                        description_en: document.querySelector("textarea[name='description_en']")
                            .value,
                        more_th: document.querySelector("#det_en").querySelector(".sk-body")
                            .innerHTML,
                        content_type: "description",
                        source_lang: "en"
                    }).then((res) => {
                        document.querySelector("textarea[name='description_th']").value = res
                            .description_th
                        document.querySelector("textarea[name='description_jp']").value = res
                            .description_jp
                        document.querySelector("textarea[name='description_zh']").value = res
        ...
        translateDescriptionBtnJp.addEventListener('click', (e) => {
            e.preventDefault()
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this!",
                ...
                if (result.isConfirmed) {
                    Translate({
                        ...
                        description_jp: document.querySelector("textarea[name='description_jp']")
                            .value,
                        more_th: document.querySelector("#det_jp").querySelector(".sk-body")
                            .innerHTML,
                        content_type: "description",
                        source_lang: "jp"
                    }).then((res) => {
        ...
        translateDescriptionBtnCn.addEventListener('click', (e) => {
            e.preventDefault()
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this!",
                ...
                if (result.isConfirmed) {
                    Translate({
                        ...
                        description_zh: document.querySelector("textarea[name='description_zh']")
                            .value,
                        more_th: document.querySelector("#det_zh").querySelector(".sk-body")
                            .innerHTML,
                        content_type: "description",
                        source_lang: "ch"
                    }).then((res) => {
