...
<body>
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div>
                                            @php($cover = $data->images != '' ? str_replace('.', '-xs.', $data->images) : 'img/no-img-banner.jpg')
                                            <img src="{{ $cover }}" class="mb-3" id="preview"
                                        ...
                                        <div class="row">
                                            ...
                                            @if ($cid == env('TCF_ID') || $cid == env('HANKYU_ID'))
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <select name="type" id="type" class="form-control">
                                                            <option value="" hidden>Choose Type ...</option>
                                                            <option value="selfedit"
                                                                @if (old('type')) {{ old('type') == 'selfedit' ? 'selected' : '' }} @else {{ $data->type == 'selfedit' ? 'selected' : '' }} @endif>
                                                                General</option>
                                                            @if ($cid == env('TCF_ID'))
                                                                <option value="ma"
                                                                    @if (old('type')) {{ old('type') == 'ma' ? 'selected' : '' }} @else {{ $data->type == 'ma' ? 'selected' : '' }} @endif>
                                                                    MA</option>
                                                            @endif
                                                            @if ($cid == env('HANKYU_ID'))
                                                                <option value="news"
                                                                    @if (old('type')) {{ old('type') == 'news' ? 'selected' : '' }} @else {{ $data->type == 'news' ? 'selected' : '' }} @endif>
                                                                    News</option>
                                                                <option value="job-search"
                                                                    @if (old('type')) {{ old('type') == 'job-search' ? 'selected' : '' }} @else {{ $data->type == 'job-search' ? 'selected' : '' }} @endif>
                                                                    Jobs</option>
                                                            @endif
                                                        </select>
                                                    </div>
                                            ...
                                            <select name="position" id="position"
                                                ...
                                                @if ($position)
                                                    @foreach (@$position['rows'] as $k => $v)
                                                        <option value="{{ $v['id'] }}"
                                                            @if (old('position')) {{ old('position') == $v['id'] ? 'selected' : '' }} @else {{ @$data->position == $v['id'] ? 'selected' : '' }} @endif>
                                            ...
                                            <select name="location" id="location"
                                                ...
                                                @foreach (@$location as $k => $v)
                                                    <option value="{{ $v->province_id }}"
                                                        @if (old('location')) {{ old('location') == $v->province_id ? 'selected' : '' }} @else {{ @$data->location == $v->province_id ? 'selected' : '' }} @endif>
                                            ...
                                            <select name="industry" id="industry"
                                                ...
                                                @if ($industry)
                                                    @foreach (@$industry as $k => $v)
                                                        <option value="{{ $v['id'] }}"
                                                            @if (old('industry')) {{ old('industry') == $v['id'] ? 'selected' : '' }} @else {{ @$industryFilter->_id == $v['id'] ? 'selected' : '' }} @endif>
                                                            {{ $v['name'] }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <input type="hidden" name="producthidden" id="producthidden"
                                                    value="{{ old('productItem') ? json_encode(old('productItem')) : json_encode($productFilter) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="opportunity" id="opportunity"
                                                ...
                                                <option value="" hidden>Choose ...</option>
                                                <option value="1"
                                                    @if (old('opportunity')) {{ old('opportunity') == 1 ? 'selected' : '' }} @else {{ $data->opportunity == 1 ? 'selected' : '' }} @endif>
                                                    Buy</option>
                                                <option value="2"
                                                    @if (old('opportunity')) {{ old('opportunity') == 2 ? 'selected' : '' }} @else {{ $data->opportunity == 2 ? 'selected' : '' }} @endif>
                                                    Sell</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input type="text" name="name_jp" id="name_jp"
                                                            ...
                                                            value="{{ old('name_jp') ? old('name_jp') : $data->name_jp }}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input type="text" name="name_zh" id="name_zh"
                                                            ...
                                                            value="{{ old('name_zh') ? old('name_zh') : $data->name_zh }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 mt-3">
                                        <div class="form-group">
                                            <label for="name_th">Url: @error('url')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </label>
                                            <input type="text" name="url" id="url"
                                                class="form-control @error('url')is-invalid @enderror"
                                                value="{{ old('url') ? old('url') : $data->url_th }}">
                                        </div>
                                    </div>
                                    {{-- description --}}
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="tab-content" id="myTab1Content">
                                            <div class="tab-pane fade show active" id="TH1" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea rows="5" name="more_th" id="more_th" class="form-control @error('more_th')is-invalid @enderror">{{ old('more_th') ? old('more_th') : $data->more_th }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade show" id="EN1" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea rows="5" name="more_en" id="more_en" class="form-control @error('more_en')is-invalid @enderror">{{ old('more_en') ? old('more_en') : $data->more_en }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade show" id="JP1" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea rows="5" name="more_jp" id="more_jp" class="form-control @error('more_jp')is-invalid @enderror">{{ old('more_jp') ? old('more_jp') : $data->more_jp }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade show" id="CH1" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea rows="5" name="more_zh" id="more_zh" class="form-control @error('more_zh')is-invalid @enderror">{{ old('more_zh') ? old('more_zh') : $data->more_zh }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {{-- detail --}}
                                    <div class="col-lg-12 mt-3">
                                        <label for="detail_th">@lang('phrase.member.activity.detail'): @error('detail_th')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="sk-area" data-lang="th"
                                                            ...
                                                            <textarea name="detail_th" id="detail_th" class="sk-editor" hidden="">{{ old('detail_th') ? old('detail_th') : $data->detail_th }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="sk-area" data-lang="en"
                                                            ...
                                                            <textarea name="detail_en" id="detail_en" class="sk-editor" hidden="">{{ old('detail_en') ? old('detail_en') : $data->detail_en }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="sk-area" data-lang="jp"
                                                            ...
                                                            <textarea name="detail_jp" id="detail_jp" class="sk-editor" hidden="">{{ old('detail_jp') ? old('detail_jp') : $data->detail_jp }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="sk-area" data-lang="th"
                                                            ...
                                                            <textarea name="detail_zh" id="detail_zh" class="sk-editor" hidden="">{{ old('detail_zh') ? old('detail_zh') : $data->detail_zh }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input type="text" name="seo_keyword_th"
                                                            ...
                                                            value="{{ old('seo_keyword_th') ? old('seo_keyword_th') : $data->seo_keyword_th }}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input type="text" name="seo_keyword_en"
                                                            ...
                                                            value="{{ old('seo_keyword_en') ? old('seo_keyword_en') : $data->seo_keyword_en }}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input type="text" name="seo_keyword_jp"
                                                            ...
                                                            value="{{ old('seo_keyword_jp') ? old('seo_keyword_jp') : $data->seo_keyword_jp }}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input type="text" name="seo_keyword_zh"
                                                            ...
                                                            value="{{ old('seo_keyword_zh') ? old('seo_keyword_zh') : $data->seo_keyword_zh }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea name="seo_description_th" class="form-control @error('seo_description_th')is-invalid @enderror"
                                                            rows="4">{{ old('seo_description_th') ? old('seo_description_th') : $data->seo_description_th }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea name="seo_description_en" class="form-control @error('seo_description_en')is-invalid @enderror"
                                                            rows="4">{{ old('seo_description_en') ? old('seo_description_en') : $data->seo_description_en }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea name="seo_description_jp" class="form-control @error('seo_description_jp')is-invalid @enderror"
                                                            rows="4">{{ old('seo_description_jp') ? old('seo_description_jp') : $data->seo_description_jp }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea name="seo_description_zh" class="form-control @error('seo_description_zh')is-invalid @enderror"
                                                            rows="4">{{ old('seo_description_zh') ? old('seo_description_zh') : $data->seo_description_zh }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        var indsutryID = "{{ old('industry') ? old('industry') : @$industryFilter->_id }}";
        ...
        if (indsutryID != '') {
            ...
            getProduct(indsutryID).then((result) => {
                result.map((e, k) => {
                    let div = document.createElement('div');
                    div.innerHTML =
                        `<label><input type="checkbox" name="productItem[]" id="productItem" value="${e.id}" ${productOld.includes(e.id) ? `checked` : `` }> ${e.name}</label>`;
                    product.append(div);
                });
            });
        }
