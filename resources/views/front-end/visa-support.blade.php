...
<head>
    ...
    <title>@lang('phrase.visa-support-caption')</title>
    ...
    <style>
        ...
        .bg-img{
            background-image:url('./images/Visa-support.jpg');
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 mt-5">
                    ...
                    <h3 class="search-header f-400">@lang('phrase.visa-support-caption')</h3>                    
                </div>
            </div>
                ...
                <div class="form-search">         
                    <form action="" method="get">           
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>@lang('phrase.visa-type')</label>
                                    <span class="form-control form-control-lg" id="type" title="@lang('phrase.visa-type')"></span>
...
<div id="tableTwo" style="display:none">
    <div class="row scroll-y"><br>
        @foreach(\App\Models\VisaTypeMd::select('id',"name_$lang as name")->get() as $k => $v)
        <div class="col-lg-6 col-xs-6">                
            <div class="qa-box">
                <div class="custom-control custom-checkbox mb-3">
                    <input type="checkbox" class="custom-control-input two_" id="two_{{$k}}" name="type[]" value="{{$v->id}}" text="{!!$v->name!!}" @if(in_array($v->id,$get['speciality'])) checked="" @endif>
