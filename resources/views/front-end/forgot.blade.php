            ...
            <div class="col-lg-5">
                <div class="card px-4 py-4 my-5">
                    <form class="formValidate" action="" method="post">
                        ...
                        <div class="row">     
                            <div class="col-lg-12">
                                <h5 class="border-bottom pb-3 text-center" style="color:#fc593b;">Forgot your password?</h5>
                            </div>
                            <div class="col-lg-12">                 
                                @if(Session('error'))
                                ...
                                <div class="form-group">
                                    <h5>@lang('phrase.member.email') : &nbsp;</h5>
                                    <input type="text" name="email" id="email" class="form-control" value="{{Session('email')}}" placeholder="Enter you email.">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<div class="footter-content" style="flex-shrink: 0;">
  ...
  <script type="text/javascript" src="js/color.js"></script>
    <script>
        errMessage = {
            email : ['อีเมลนี้ไม่มีอยู่ในระบบ','This email does not exist in the system.'],
        },
        reqMessage = {
            email : ['กรอกอีเมลของคุณ.','Enter your email.'],
        },
        lang = $('html').attr('lang'),
        hl = (lang=='th')?0:1,
