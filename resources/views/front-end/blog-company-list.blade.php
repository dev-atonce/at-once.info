@if (count($blogs_company) > 0)
    <div id="blogs">
        <div class="container">
            <div class="d-flex">
                <h2 class="bold mb-3 XWyRR" style="font-weight: bold; line-height: 45px"><span
                        class="text-orange mr-2">@lang('phrase.header.blog-company')</span> @lang('phrase.header.company')</h2>
                <div><a class="b-view-more gKiAgG"
                        href="{{ Session('lang') }}/blog-company?category={{ $categoryId }}">@lang('phrase.see-all')
                        »</a></div>
            </div>
            <div class="row">
                @foreach ($blogs_company as $v)
                    @php
                        if ($v->type == 'general') {
                            $bullet = '--c-skyblue';
                ...
                <div class="col-lg-12 mb-4">
                    <center>
                        <a href="{{ Session('lang') }}/blog-company?category={{ $categoryId }}"
