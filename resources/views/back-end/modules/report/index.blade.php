...
<head>
    ...
    <link href="back-end/css/validate.css" rel="stylesheet">
        ...
        <div class="c-body">
            ...
            <main class="c-main">
                <div class="container-fluid">
                        ...
                        @if(Request::segment(4) == 'customer' || Request::segment(4) == '')
                            @include("back-end.modules.report.inquiry-customer")
                        @endif
                        @if(Request::segment(4) == 'popup')
                            @include("back-end.modules.report.inquiry-popup")
                        @endif
                    </div>
                </main>
            </div>
