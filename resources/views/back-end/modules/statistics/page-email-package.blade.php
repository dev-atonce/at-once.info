        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span class="breadcrumb-item "><a href="{{ url("$prefix$segment") }}">
                            @if ($segment == 'packagemail')
                                Email Package
                            @elseif ($segment == 'contact-from-basic')
                                Email Basic
                            @else
                                Email Contact Us
                            @endif
                        </a></span><small class="badge badge-secondary"><a href="webpanel/export/{{ $url }}"
                            target="_blank" class="export"><i class="fas fa-file-export"></i>
                            Export.csv</a></small>
                </div>
                <div class="card-body">
                    <div class="card p-3">
