                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            @endphp
                                            <img src="{{$image}}" class="card-img" alt="{{$row->name_th}}" id="preview">
                                            ...
                                            <div class="mt-4">
                                                <label>Url:</label>
                                                <input type="text" id="urlTH" class="form-control name" data-target="urlTH" name="urlTH" value="{{$row->url_th}}" required>
                                            </div>
                                            {{-- <div class="mt-4">
                                                <label>Url JP:</label>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <select name="category" class="form-control" required>
                                                    ...
                                                    @if(!empty($category))
                                                        ...
                                                        <option value="{{$vi->id}}" @if($vi->id == $row->type) selected @endif>{{$vi->name_th}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="row mt-4">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name_th"  value="{{$row->name_th}}" data-target="urlTH" class="form-control name" required>
                                                    </div>
                                                </div> 
                                                {{-- <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label>ชื่อบทความ (JP)</label>
                                                        <input type="text" name="name_jp"  value="{{$row->name_jp}}" data-target="urlJP" class="form-control name" required>
                                                    </div>
                                                </div> --}}
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        <div class="tab-pane fade show active" id="TH1" role="tabpanel" aria-labelledby="TH1-tab">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control tiny1" rows="5" name="description_th">{{$row->description_th}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade" id="JP1" role="tabpanel" aria-labelledby="JP1-tab">
                                                            <div class="form-group">
                                                                <label>รายละเอียดย่อ (JP)</label>
                                                                <textarea class="form-control tiny1" rows="5" name="description_jp">{{$row->description_jp}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> --}}
                                                    ...
                                                    <div class="tab-content" id="myTab2Content">
                                                        <div class="tab-pane fade show active" id="TH2" role="tabpanel" aria-labelledby="TH2-tab">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control tiny" rows="5" name="detail_th">{!!$row->detail_th!!}</textarea>
                                                            </div>
                                                        </div>
                                                        {{-- <div class="tab-pane fade show" id="JP2" role="tabpanel" aria-labelledby="JP2-tab">
                                                            <div class="form-group">
                                                                <label>รายละเอียดเต็ม (JP)</label>
                                                                <textarea class="form-control tiny" rows="5" name="detail_jp">{!!$row->detail_jp!!}</textarea>
                                                            </div>
                                                        </div> --}}
                                                    </div>
                                                </div>
                                            ...
                                            @php
                                                // $gallery = \App\Models\Filter\CpGalleryMd::where('_id',$row->id)->get();
                                            @endphp
                                            <hr/>
                                            {{-- <div class="row">
                                                <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <label>Tag:</label>
                                                    @php
                                                        $get_join = DB::table('tag')->select('tag.tag')
                                                                        ->leftJoin('blog_join_tag as join','join.tag_id','=','tag.id')
                                                                        ->where('join.blog_id',$row->id)->get();
                                                    ...
                                                    @endphp
                                                    <input type="text" class="form-control" name="tag" id="tokenfield" value="{{$join_array}}"  />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <label>Keyword :</label>
                                                    <input type="text" name="seo_keyword" class="form-control" value="{{$row->seo_keyword}}">
                                                </div>
                                                <div class="col-lg-12">
                                                    <label>Description :</label>
                                                    <textarea name="seo_description" class="form-control" rows="4">{{$row->seo_discription}}</textarea>
                                                </div>
                                            </div>
                                            <hr />
