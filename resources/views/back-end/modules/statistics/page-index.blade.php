                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="input-group">
                                <input type="text" id="daterangeVisitor" class="form-control" name="daterange"
                                    readonly style="background-color:whitesmoke;">
                                <div class="input-group-prepend">
                                    <button class="btn btn-primary input-sm btn-search" type="button"
                                        data-type="clicks"><i class="fas fa-search"></i>&nbsp;Search</button>
                                    <button class="btn btn-danger input-sm btn-reset" type="button"
                                        data-type="clicks"><i class="fas fa-sync-alt"></i>&nbsp;Reset</button>
                                </div>
                            </div>
                            <div class="mb-3"></div>
                        </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-2 text-dark text-center">
                            ...
                            <h4 class="view-package">
                                {{ number_format(\App\Models\PageCounterMd::where('page', 'promotion-package')->count()) }}
                            </h4>
                        </div>
                        <div class="col-lg-2 text-dark text-center">
                            <h5>ปิด Popup</h5>
                        ...
                        <div class="col-lg-2 text-dark text-center">
                            ...
                            <hr style="border-top: 1px solid rgba(60, 60, 60, 0.5) !important;">
                            <h4 class="send-popup">
                                {{ number_format(\App\Models\SMSHistoryMd::where('company', null)->count()) }}</h4>
                        </div>
                        <div class="col-lg-2 text-dark text-center">
                            <h5><a href="webpanel/statistics/packagemail">ส่งอีเมลหน้า Package</a></h5>
                            <hr style="border-top: 1px solid rgba(60, 60, 60, 0.5) !important;">
                            <h4 class="send-package">
                                {{ number_format(\App\Models\ContactMd::where('type', 'package')->count()) }}</h4>
                        </div>
                        <div class="col-lg-2 text-dark text-center">
                            <h5><a href="webpanel/statistics/contactusemail">ส่งอีเมลหน้า Contact US</a></h5>
                            <hr style="border-top: 1px solid rgba(60, 60, 60, 0.5) !important;">
                            <h4 class="send-contactus">
                                {{ number_format(\App\Models\ContactMd::where('type', null)->count()) }}</h4>
                        </div>
                        <div class="col-lg-2 text-dark text-center">
                            <h5><a href="webpanel/statistics/contact-from-basic">Basic Profile</a></h5>
                            <hr style="border-top: 1px solid rgba(60, 60, 60, 0.5) !important;">
                            <h4 class="send-basic">
                                {{ number_format(\App\Models\ContactMd::where('type', 'basic')->count()) }}</h4>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row p1">
                                        ...
                                        <div class="col-12">
                                            <ul style="list-style-type: none; padding:0;">
                                                <li><a href="webpanel/export/all-company"><i
                                                            class="fas fa-download"></i> All Company (Online)</a></li>
                                                <li><a href="webpanel/history-mail/export"><i
                                                            class="fas fa-download"></i> Email History</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mt-4">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="st-country" style="width: 100%;">
                                                <thead>
                                                    <th width="10%">#</th>
...
<script>
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'ค่าเฉลี่ยบราวเซอร์ ในการการเยี่ยมชมรายละเอียดบริษัทฯ'
        },
        subtitle: {
    ...
    function statisticsLocate(len) {
        ...
        const response = $.ajax({
            url: 'api/statistics/locate' + stLength,
            async: false,
            dataType: 'json'
        }).responseJSON;
        return response;
    ...
    function browserStatistics() {
        const stLength = (len != null) ? '?len=' + len : '';
        const response = $.ajax({
            url: 'api/statistics/browser' + stLength,
            async: false,
            dataType: 'json'
        }).responseJSON;
        return response;
    ...
    const clickCustom = (request) => {
        ...
        console.log(request);
        const stClick = $.ajax({
            url: 'api/statistics/click-custom' + request,
            async: false
        }).responseJSON
