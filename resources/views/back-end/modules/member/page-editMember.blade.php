...
<div class="fade-in">
            ...
            <div class="col-lg-12 col-md-12">
                <form id="form" method="post" action="" enctype="multipart/form-data"> 
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="pb-2">
                                <button class="btn btn-primary btn-sm" type="submit" name="signup">Update</button>
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <h6>Cover</h6>
                                                    <img src="{{$image}}" class="img-thumbnail" id="preview">
                                                </div>                                        
                                            </div>
                                        </div>
                                    </div>   
                                ...
                                <div class="col-lg-8"> 
                                    <div class="row"> 
                                        <div class="form-group col-lg-12">
                                            <h6>Name TH</h6>
                                            <input type="text" name="name_th" class="form-control" value="{{$row->name_th}}" required />
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <h6>Name JP</h6>
                                            <input type="text" name="name_jp" class="form-control" value="{{$row->name_jp}}" required />
                                        </div>
                                    ...
                                    <hr/>
                                    <a href="javascript:void(0)" class="btn btn-warning btn-sm" id="btnReset">Reset Password</a>
                                    <div class="row mt-4" style="display: none" id="resetPass">
                                        <div class="form-group col-lg-6">
                                            <h6>Password</h6>
    ...
    <script>
        ...
        $(function(){
          $('#form').validate({
              rules:{
                  ...
                  'email':{required:true,remote:{url:"{{url('webpanel/members/check/email/duplicate')}}",data:{_token:"{{ csrf_token() }}",id:"{{$row->id}}"},type:"post"}},
                  'name':{required:true},
              },
              messages:{
                  email:{
        ...
        $('#btnReset').click(function(){
            if ( $( "#resetPass" ).first().is( ":hidden" ) ) {
                $( "#resetPass" ).slideDown( "slow" );
            } else {
                $( "#resetPass" ).hide();
            }
        });
